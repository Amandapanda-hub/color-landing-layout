...
export default function Testimony() {
  ...
  return (
    <div className="flex items-center justify-center h-screen macbook-h-screen bg-white">
      <div className={`relative ${fade}`}>
        <img src={currentTestimony.img} alt="description" className="w-3/4 h-[30rem] object-cover mx-auto md:w-full md:h-[40rem] lg:w-full lg:h-[50rem] xl:w-full xl:h-[50rem]"/>
